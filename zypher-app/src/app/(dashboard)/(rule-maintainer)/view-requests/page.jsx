...
const initialRuleRequests = [
  ...
  {
    id: "req-005",
    ruleName: "Disable Debug Mode in Production",
    description: "Flags configuration files that leave debug mode enabled in production environments, which can expose sensitive information.",
    severity: "high",
    targetFileTypes: ".json, .env",
    exampleCode: `{ "app": { "debug_mode": true, "environment": "production" } }`,
    status: "approved",
    submittedDate: "2025-06-18T16:00:00Z",
    requesterId: "user-epsilon",
    developerNotes: "Rule is now live and actively scanning. Monitoring performance.",
    testerNotes: "Extensive testing confirmed rule accuracy and performance.",
    discardReason: null,
  },
  {
    id: "req-006",
