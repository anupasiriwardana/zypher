...
const RuleExplorer = ({
  ...
  return (
    <div
      className={clsx(
        "bg-[var(--input-bg)] rounded-xl shadow-2xl border border-[var(--border-input)] flex flex-col transition-all duration-300 relative h-full overflow-hidden",
        isSidebarCollapsed ? "w-16 p-2" : "w-full p-4"
      )}
    >
