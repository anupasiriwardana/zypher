...
export default function TestimonialsSection() {
  ...
  const handleMouseMove = (e) => {
    if (!isDragging) return;
    touchEndX.current = e.clientX; // Reuse touchEndX for consistency
  };
  ...
  return (
    <section className="min-h-[80vh] w-full px-4">
      ...
      <div className="w-full flex justify-center mt-16 overflow-hidden">
        <div 
          className="w-full max-w-4xl relative overflow-hidden cursor-grab"
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div
                ...
                style={{ minWidth: "100%" }}
              >
                <div className="relative bg-[#0F0F0F] border border-[#333] rounded-3xl w-full max-w-3xl mx-auto h-[230px] flex items-center px-8 py-6 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] hover:border-[var(--brand-yellow)] ">
                  {/* Left: Avatar */}
                  ...
                  {/* Right: Content */}
                  <div className="flex flex-col justify-between h-full py-4 w-full px-8 text-[16px]" >
